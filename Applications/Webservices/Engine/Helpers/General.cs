...
namespace DynamicConnections.NutriStyle.CRM2011.WebServices.Engine
{
    public class General
    {
        ...
        public static decimal CalculateKcals(decimal carbohydrates, decimal fat, decimal protein, decimal alcohol)
        {
            return ((carbohydrates * 4) + (fat * 9) + (protein * 4) + (alcohol * 7));
        }
    }
}